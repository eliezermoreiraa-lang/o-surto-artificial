(() => {
  ...
  function ensureCss(){
    ...
    style.textContent = `
      ...
      @media(max-width:900px){.sd-checkout-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:620px){.sd-vip-points{grid-template-columns:1fr}.sd-vip-image-grid{grid-template-columns:1fr 1fr}}@media(max-width:520px){.sd-checkout-grid{grid-template-columns:1fr}.sd-plan-card{min-height:0}.sd-locked{padding:24px}}
    `;
